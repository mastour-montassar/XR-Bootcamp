    ...
    public partial class StarterAssetsDeployMenu : ScriptableObject
    {
        ...
        static void ResetPackageChecker()
        {
           // PackageChecker.RemovePackageCheckerScriptingDefine();
            // Removed the call to PackageChecker.RemovePackageCheckerScriptingDefine() since it does not exist
            Debug.Log("Package Checker reset functionality is not implemented.");
        }
